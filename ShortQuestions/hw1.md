...
Plugins are tools that <u>provide specific functionalities to perform various tasks during the build process</u>
...
- **maven-deploy-plugin**: Deploys project artifacts to a remote repository.
...
find coding file : hw1-MavenProject
