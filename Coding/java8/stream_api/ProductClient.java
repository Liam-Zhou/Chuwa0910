...
public class ProductClient {
    ...
    public void toSet() {
        ...
        Set<String> unique = productList.stream()
    ...
    public void groupingBy() {
        ...
        Map<String, Integer> categoryStocks = productList.stream()
    ...
    public void partitioningBy() {
        ...
        Map<Boolean, List<Product>> partitions = productList.stream()
                .collect(Collectors.partitioningBy(p -> p.getPrice() > 100));
    }

    @Test
    public void mapping() {
        // Get the set of all product names in UpperCase
