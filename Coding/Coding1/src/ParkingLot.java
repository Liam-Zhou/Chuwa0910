...
//停车场的设计
// Creates a Parking Lot with the Number of levels and the slots in each of the given levels.
public class ParkingLot
{
    ...
    // key contains the company name and value is the vehicles present in the list
